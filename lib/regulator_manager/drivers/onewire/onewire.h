#ifndef LIB_REGULATOR_MANAGER_DRIVERS_ONEWIRE_ONEWIRE_H_
#define LIB_REGULATOR_MANAGER_DRIVERS_ONEWIRE_ONEWIRE_H_
...
#endif  // LIB_REGULATOR_MANAGER_DRIVERS_ONEWIRE_ONEWIRE_H_
