# -*- coding: utf-8 -*-
#
# esp32-pcd8544 documentation build configuration file, created by
# sphinx-quickstart on Mon Sep 18 16:15:42 2017.
#
...
project = u'esp32-pcd8544'
copyright = u'2017, yanbe'
author = u'yanbe'
...
htmlhelp_basename = 'esp32-pcd8544doc'
...
man_pages = [
    (master_doc, 'esp32-pcd8544', u'esp32-pcd8544 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'esp32-pcd8544', u'esp32-pcd8544 Documentation',
     author, 'yanbe', 'PCD8544 component for ESP32',
     'Miscellaneous'),
]
